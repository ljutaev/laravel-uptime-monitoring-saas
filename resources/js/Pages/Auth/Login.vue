    ...
    <GuestLayout>
        ...
        <div>
            <div class="mb-5 sm:mb-8">
                <h1 class="text-xl sm:text-title-md mb-2 font-semibold text-gray-800 dark:text-white/90">
                    Sign In
                </h1>
            ...
            <div>
                <div class="hidden">
                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
                        <button class="inline-flex items-center justify-center gap-3 rounded-lg bg-gray-100 px-7 py-3 text-sm font-normal text-gray-700 transition-colors hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10">
                ...
                <div class="mt-5">
                    <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                        ...
                        <a :href="route('register')" class="text-blue-500 hover:text-blue-600 dark:text-brand-400">Sign Up</a>
                    </p>
                </div>
            </div>
        </div>
