        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-8">
            <article class="flex items-center gap-5 rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/3">
                <div class="inline-flex h-16 w-16 items-center justify-center rounded-xl bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-white/90">
                    <svg class="h-7 w-7" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                            ...
                            <tr class="border-t border-gray-100 dark:border-gray-800">
                                <td class="px-6 py-3.5">
                                    <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">
                                        <span class="inline-block rounded-full px-2 py-0.25 font-medium text-white bg-green-500">
                                            200
                                        </span>
                                    </p>
                                </td>
                                <td class="px-6 py-3.5">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400 text-right">290 ms</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="max-w-full overflow-x-auto custom-scrollbar">
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="border-t border-gray-100 dark:border-gray-800">
                                <td class="px-6 py-3.5 -mt-4">
                                    <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90 flex gap-1 items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-green-500 text-success mr-2" viewBox="0 0 20 20"><path d="m10,0C4.48,0,0,4.48,0,10s4.48,10,10,10,10-4.48,10-10S15.52,0,10,0Zm-1.77,14.41l-3.8-3.81,1.48-1.48,2.32,2.33,5.85-5.87,1.48,1.48-7.33,7.35Z"></path></svg>
